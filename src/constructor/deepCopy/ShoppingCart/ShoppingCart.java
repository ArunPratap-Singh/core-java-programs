package constructor.deepCopy.ShoppingCart;
...
public class ShoppingCart {
	    ...
	    ShoppingCart(ShoppingCart s) {
	        ...
	        this.p = new Product();
	        this.p.category = s.p.category;
	        this.p.manufacturer = s.p.manufacturer;
	        this.p.price = s.p.price;
	        this.p.productId = s.p.productId;
	        this.p.productName = s.p.productName;
	        this.p.weight = s.p.weight;
	    }
