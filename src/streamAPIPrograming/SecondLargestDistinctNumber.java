...
public class SecondLargestDistinctNumber {
	...
	public static void main(String[] args) {
		...
		int secondlargestdistinctnumber = l.stream().distinct().sorted((n1,n2)->n2-n1).skip(1).findFirst().get().intValue();
		
		System.out.println("second-largest distinct number in " +l+ " is: " +secondlargestdistinctnumber);
