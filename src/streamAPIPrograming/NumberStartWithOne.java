...
public class NumberStartWithOne {
	...
	public static void main(String[] args) {
		...
		l.stream().filter(n->String.valueOf(n).startsWith("1")).forEach(n->System.out.print(n+ " "));
		
		l.stream().filter(n->String.valueOf(n).startsWith("2")).forEach(n->System.out.print(n+ " "));
	}
